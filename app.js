...
/* Generated by Opal 0.10.2 */
Opal.modules["core_ext"] = function(Opal) {
  ...
  (function($base) {
    ...
    Opal.defn(self, '$p', TMP_1 = function ːp($a_rest) {
      var self = this, args;
    ...
    Opal.defn(self, '$client_require', TMP_2 = function ːclient_require(file) {
      var self = this;
  ...
  return (function($base, $super) {
    ...
    return (Opal.defs(self, '$read', TMP_3 = function ːread(file) {
      var self = this;

      return require('fs').readFileSync(file, 'utf8').toString();
    }, TMP_3.$$arity = 1), nil) && 'read'
  })($scope.base, null);
};

/* Generated by Opal 0.10.2 */
Opal.modules["hash_to_object"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;
  ...
  return (function($base, $super) {
    ...
    return (Opal.defn(self, '$to_object', TMP_1 = function ːto_object() {
      var self = this;
    ...
    }, TMP_1.$$arity = 0), nil) && 'to_object'
  })($scope.base, null)
};

/* Generated by Opal 0.10.2 */
Opal.modules["buble"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$add_route', '$<<', '$routes', '$downcase', '$each', '$first', '$=~', '$last', '$puts', '$inspect', '$call', '$[]=', '$[]', '$include', '$start', '$Array', '$process', '$==', '$class', '$attr_reader']);
  self.$require("hash_to_object");
  return (function($base, $super) {
    function $Buble(){};
    var self = $Buble = $klass($base, $super, 'Buble', $Buble);

    var def = self.$$proto, $scope = self.$$scope, TMP_7, TMP_8, TMP_10;

    def.port = nil;
    (function($base) {
      var $Sinatra, self = $Sinatra = $module($base, 'Sinatra');

      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_5, TMP_6;

      Opal.defn(self, '$get', TMP_1 = function ːget(regexp) {
        var self = this, $iter = TMP_1.$$p, action = $iter || nil;

        TMP_1.$$p = null;
        return self.$add_route("get", regexp, action);
      }, TMP_1.$$arity = 1);

      Opal.defn(self, '$post', TMP_2 = function ːpost(regexp) {
        var self = this, $iter = TMP_2.$$p, action = $iter || nil;

        TMP_2.$$p = null;
        return self.$add_route("post", regexp, action);
      }, TMP_2.$$arity = 1);

      Opal.defn(self, '$add_route', TMP_3 = function ːadd_route(method, regexp, action) {
        var self = this;

        return self.$routes(method)['$<<']([regexp, action]);
      }, TMP_3.$$arity = 3);

      Opal.defn(self, '$process', TMP_5 = function ːprocess(request) {
        var $a, $b, TMP_4, self = this, route = nil, action = nil, method = nil, path = nil;

        $a = [nil, nil], route = $a[0], action = $a[1], $a;
        method = (request.method).$downcase();
        path = request.url;
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = self.$routes(method)).$each, $a.$$p = (TMP_4 = function(route_and_action){var self = TMP_4.$$s || this, $c;
if (route_and_action == null) route_and_action = nil;
        route = route_and_action.$first();
          if ((($c = route['$=~'](path)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            action = route_and_action.$last();
            
            Opal.brk(nil, $brk);
            } else {
            return nil
          };}, TMP_4.$$s = self, TMP_4.$$brk = $brk, TMP_4.$$arity = 1, TMP_4), $a).call($b)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
        if (action !== false && action !== nil && action != null) {
          self.$puts("\nProcessing " + (method) + " " + (path.$inspect()) + " with " + (route.$inspect()));
          action._s = this;
      ...
      Opal.defn(self, '$routes', TMP_6 = function ːroutes(method) {
        var $a, self = this;
        if (self.routes == null) self.routes = nil;

        self.routes = ((($a = self.routes) !== false && $a !== nil && $a != null) ? $a : $hash2([], {}));
        return self.routes['$[]='](method, ((($a = self.routes['$[]'](method)) !== false && $a !== nil && $a != null) ? $a : []));
      }, TMP_6.$$arity = 1);
    })($scope.base);

    self.$include($scope.get('Sinatra'));

    Opal.defn(self, '$initialize', TMP_7 = function ːinitialize(port) {
      var self = this;
    ...
    Opal.defn(self, '$start', TMP_8 = function ːstart() {
      var self = this, $iter = TMP_8.$$p, block = $iter || nil;
    ...
    Opal.defn(self, '$start!', TMP_10 = function() {
      var $a, $b, TMP_9, self = this;

      self.$puts("Starting Buble server on port " + (self.port));
      return ($a = ($b = self).$start, $a.$$p = (TMP_9 = function(request){var self = TMP_9.$$s || this, out = nil;
        if (self.body == null) self.body = nil;
        if (self.status == null) self.status = nil;
        if (self.headers == null) self.headers = nil;
if (request == null) request = nil;
      self.status = 200;
        self.headers = $hash2(["Content-Type"], {"Content-Type": "text/html"});
        self.body = self.$Array(self.$process(request));
        out = (function() {if (self.body.$class()['$==']($scope.get('Array'))) {
          return self.body.$first()
          } else {
          return self.body
        }; return nil; })();
        return [self.status, self.headers, self.body];}, TMP_9.$$s = self, TMP_9.$$arity = 1, TMP_9), $a).call($b);
    }, TMP_10.$$arity = 0);

    return self.$attr_reader("server");
  })($scope.base, null);
};

/* Generated by Opal 0.10.2 */
(function(Opal) {
  var $a, $b, TMP_1, $c, TMP_2, $d, TMP_3, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, server = nil;

  Opal.add_stubs(['$require', '$new', '$get', '$post', '$start!']);
  self.$require("core_ext");
  self.$require("buble");
  server = $scope.get('Buble').$new(3000);
  ($a = ($b = server).$get, $a.$$p = (TMP_1 = function(response){var self = TMP_1.$$s || this;
if (response == null) response = nil;
  return "  <html>\n    <head>\n      <title>Ahoy!</title>\n    </head>\n    <body>\n      <h1>Ciao!</h1>\n      <form action='/salute' method='post'>\n        <input type=\"text\" name=\"name\" placeholder='your name!'/>\n      </form>\n    </body>\n  </html>\n"}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $a).call($b, /ciao/);
  ($a = ($c = server).$post, $a.$$p = (TMP_2 = function(response){var self = TMP_2.$$s || this;
if (response == null) response = nil;
  return "Hi asdfsa" + (response.body)}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $a).call($c, /salute/);
  ($a = ($d = server).$get, $a.$$p = (TMP_3 = function(response){var self = TMP_3.$$s || this;
if (response == null) response = nil;
  return ["Hi asdfsa" + (response.url), 200]}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3), $a).call($d, /.*/);
  return server['$start!']();
})(Opal);
